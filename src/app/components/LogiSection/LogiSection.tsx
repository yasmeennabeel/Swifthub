    ...
    return (
        <div className="mx-auto px-4 w-full max-w-screen-xl my-10 flex flex-col gap-5">
            ...
            <div className="flex flex-col md:flex-row items-center gap-5 md:justify-between">
                <div className="card bg-black text-white w-[250px] h-auto md:h-[230px] shadow-2xl rounded-2xl pt-3 px-4 pb-5 flex flex-col justify-between">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[8px] text-center md:text-start md:text-xs text-gray-300">Get your shipments delivered at lightening speed with our express shipping service. We prioritize fast processing, quick dispatch, and on-time delivieries. </p>

                    </div>
                </div>
                <div className="card  w-[250px]   h-auto md:h-[230px] shadow-2xl rounded-2xl pt-3 px-4 pb-5 flex flex-col justify-between">
                    <div className="flex justify-between  p-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 md:size-6">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[8px] text-center md:text-start md:text-xs text-gray-600">Get your shipments delivered at lightening speed with our express shipping service. We prioritize fast processing, quick dispatch, and on-time delivieries. </p>
