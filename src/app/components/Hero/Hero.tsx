            ...
            <div className="relative bg-white rounded-3xl overflow-hidden shadow-lg mt-6 max-w-6xl mx-auto group">
             <div className='overflow-hidden rounded-3xl'>
                   <Image
                    ...
                    width={1100}
                    height={600}
                    className="w-full h-auto object-cover transition-transform duration-500 ease-in-out group-hover:scale-105 cursor-pointer"
                />
             </div>
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-6">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="flex items-center gap-2 text-white bg-gray-500 bg-opacity-90 rounded-full px-3 py-1 shadow">
                        ...
                        <div className="bg-opacity-80 text-white bg-gray-500 rounded-full px-3 py-1 shadow flex items-center gap-2">
                    ...
                    <div className='hidden md:flex md:absolute md:top-[-5px] md:left-1/2 transform -translate-x-1/2 pt-4'>
                        <div className='relative flex justify-center items-start'>
                            ...
                            <div className="bg-white p-2 px-2.5 pt-0 rounded-4xl rounded-t-none relative flex gap-3 z-10">
                                <button className="bg-orange-500 text-white px-5 py-2 rounded-3xl text-sm shadow hover:bg-white hover:text-orange-500 hover:border hover:border-1-orange-500 transition cursor-pointer">
                                    Our Services
                                </button>
                                <button className="bg-white text-orange-500 border border-orange-500 px-5 py-2 rounded-2xl text-sm shadow hover:bg-orange-500 hover:text-white transition cursor-pointer">
                                    Contact Us
                                </button>
                            </div>
                        </div>
